 ...
 */
@WebServlet("/TalkMain2Servlet")
public class TalkMain2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public TalkMain2Servlet() {
		super();
	...
	//		System.out.println("introget:"+ans);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/jsp/talk/main3.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (maskMap != null) {
			...
			ViewerDao vdao=new ViewerDao();
			vdao.insert_ans4(ans,title,name);
			List<Viewer>viewerList = vdao.selectViewer(title,name);
