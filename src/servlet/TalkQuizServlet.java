 ...
 */
@WebServlet("/TalkQuizServlet")
public class TalkQuizServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public TalkQuizServlet() {
		super();
...
//				}
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/jsp/talk/answer.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (maskMap != null) {
			...
			ViewerDao vdao=new ViewerDao();
			vdao.insert_ans8(ans,title,name);
			List<Viewer>viewerList = vdao.selectViewer(title,name);
