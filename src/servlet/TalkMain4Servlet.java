 ...
 */
@WebServlet("/TalkMain4Servlet")
public class TalkMain4Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public TalkMain4Servlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/jsp/talk/main5.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (maskMap != null) {
			...
			ViewerDao vdao = new ViewerDao();
			vdao.insert_ans6(ans, title, name);
			List<Viewer> viewerList = vdao.selectViewer(title, name);
...
//					e.printStackTrace();
			...
			if (ans.contains("ミサイル") || (ans.contains("ドローン"))) {
				String res = resp.get(0);
				request.setAttribute("res", res);
//				Audio audio = new Audio();
//				try{
