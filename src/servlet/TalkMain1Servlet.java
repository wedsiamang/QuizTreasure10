 ...
 */
@WebServlet("/TalkMain1Servlet")
public class TalkMain1Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public TalkMain1Servlet() {
		super();
	...
	//		System.out.println("introget:"+ans);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/jsp/talk/main2.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (maskMap != null) {
			...
			ViewerDao vdao=new ViewerDao();
			vdao.insert_ans3(ans,title,name);
			List<Viewer>viewerList = vdao.selectViewer(title,name);
			
			request.setAttribute("viewerList", viewerList);
			
				if (ans.contains("大臣")||(ans.contains("天才"))) {
