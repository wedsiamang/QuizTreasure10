...
<body>
	...
	<div class="line-bc">
		...
		<div class="mycomment">
			<form action="/TalkMain5Servlet?maskMap=maskMap"
				method="post">
				<p>
					<select name="ans" class="form-control">
						<option value="">選択して</option>
						<option value="考えとく">考えとく</option>
	...
	<div class="line-bc">
		...
		<div class="mycomment">
			<form action="/TalkMain5Servlet?snowden=snowden"
				method="post">
				<p>
					<select name="ans" class="form-control">
						<option value="">選択して</option>
	...
	<div class="line-bc">
		...
		<div class="mycomment">
			<form action="/TalkMain5Servlet?starLink=starLink"
				method="post">
				<p>
					<select name="ans" class="form-control">
						<option value="">選択して</option>
