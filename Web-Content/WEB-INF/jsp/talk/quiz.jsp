...
<body>
	...
	<div class="line-bc">
		...
		<div class="mycomment">
			<form action="/TalkQuizServlet?maskMap=maskMap"
				method="post">
				<p>
					<select name="ans" class="form-control">
						<option value="">選択して</option>
						<option value="市民ハッカー">市民ハッカー</option>
						<option value="IT大臣">IT大臣</option>
	...
	<div class="line-bc">
		...
		<div class="mycomment">
			<form action="/TalkQuizServlet?snowden=snowden"
				method="post">
				<p>
					<select name="ans" class="form-control">
						<option value="">選択して</option>
						<option value="ジャーナリスト">ジャーナリスト</option>
						<option value="CIA">CIA</option>
						<option value="テロリスト">テロリスト</option>
					</select> <input type="submit">
				</p>
			</form>
	...
	<div class="line-bc">
		...
		<div class="mycomment">
			<form action="/TalkQuizServlet?starLink=starLink"
				method="post">
				<p>
					<select name="ans" class="form-control">
						<option value="">選択して</option>
						<option value="スターリンク">スターリンク</option>
						<option value="スタートレック">スタートレック</option>
